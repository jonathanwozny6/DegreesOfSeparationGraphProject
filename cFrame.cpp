...
cFrame::cFrame() : wxFrame(nullptr, wxID_ANY, "Degrees of Separation", wxPoint(30, 30), wxSize(500, 550))
{
    m_btn1 = new wxButton(this, 10001, "Find Path", wxPoint(50,110), wxSize(100,80));
    m_btn2 = new wxButton(this, 10002, "Largest Distance", wxPoint(260, 90), wxSize(200,80));

    m_txt1 = new wxTextCtrl(this, wxID_ANY, "", wxPoint(10,30), wxSize(200,30));
    m_txtLbl1 = new wxStaticText(this, wxID_ANY, "Enter From User", wxPoint(10, 10), wxSize(200, 30));
    m_txt2 = new wxTextCtrl(this, wxID_ANY, "", wxPoint(10,90), wxSize(200,30));
    m_txtLbl2 = new wxStaticText(this, wxID_ANY, "Enter Target User", wxPoint(10, 70), wxSize(200, 30));
    m_txtLbl3 = new wxStaticText(this, 10003, "", wxPoint(355, 80), wxSize(30,30));

    m_txtLblPath = new wxStaticText(this, wxID_ANY, "Path: ", wxPoint(10, 170), wxSize(200, 30));
    m_txtLblTotCon = new wxStaticText(this, wxID_ANY, "Total Connections: ", wxPoint(310, 40), wxSize(200, 30));

    m_list1 = new wxListBox(this, wxID_ANY, wxPoint(10,190), wxSize(200,300));
...
{
    m_list1->AppendString(m_txt1->GetValue() + " --> " + m_txt2->GetValue());
    int in, out;
    ///// figure out how to convert this to an int
    //wxAtoi(*m_txt1);
    //m_txtLbl3->SetLabel(std::to_string(BFSConnect(ToLong(m_txt1), ToLong(m_txt2))));
    evt.Skip(); // tell computer that this event has been handled
}

void cFrame::OnButtonClickedSec(wxCommandEvent &evt)
{
    //m_txtLbl3->SetLabel(std::to_string(BFSConnect(1,5))); // changes the label
    evt.Skip();
}
...
unsigned int cFrame::DijkstrasConnect(const unsigned int user, const unsigned int target)
{
    // your code
